  ...
  return (
    <div className="relative my-4 lg:my-12 container mx-auto">
      <div className="flex flex-col mx-auto">
        ...
        <div>
          <div className="absolute top-2/3 transform -translate-y-1/2 flex z-10">
            ...
            {projectData.map((project, index) => (
              <div key={index} className="mx-auto">
                <Card className="group relative mx-2 md:mx-4 shadow-xl dark:bg-[#0C0A09] dark:shadow-secondary dark:shadow-lg max-w-[400px] mb-12 p-1">
                  ...
                  <CardDescription className="text-muted-foreground text-sm md:text-base xl:text-lg mb-2 font-light line-clamp-2 px-5 pb-9 md:pb-12">
                    {project.description}
                  </CardDescription>
                </Card>
              </div>
          ...
          <div className="absolute top-2/3 right-8 transform -translate-y-1/2 z-10">
            <Button onClick={next}>
              <ChevronRight />
            </Button>
          </div>
