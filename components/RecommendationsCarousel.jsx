                ...
                <Card className="group relative  mx-2 md:mx-4 shadow-xl dark:bg-[#0C0A09] dark:shadow-secondary dark:shadow-lg max-w-[400px] mb-12">
                  <div className="flex items-center">
                    <Image
                      ...
                      width={70}
                      height={70}
                      className="shadow-lg border p-1 dark:shadow-lg dark:shadow-secondary object-cover object-center rounded-full mx-4 my-5"
                      priority="true"
                    />
                    <div className="flex flex-col">
                      <p className="text-base xl:text-2xl xl:leading-normal font-semibold; px-4 pt-5">{recommendation.name}</p>
                      <p className="px-4 pb-5 text-xs">{recommendation.job}</p>
                    </div>
                  </div>
                  <CardDescription className="h-64 md:h-48 text-muted-foreground border text-sm  font-light px-5 pb-10">
